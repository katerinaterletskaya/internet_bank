...
<div class="content" style="border: 2px solid rgba(0,0,0,.3); border-radius: 4px;">
    <table style="width:29%; margin-left:50px; margin-bottom: 15px; margin-top:50px;">
        <tr>
            <td class="label" style="font-size: 18px;"><p style="text-align: justify;">Введите номер телефона, на
                который хотите перечислить деньги.</p></td>
        </tr>
    </table>
    <form action="${pageContext.request.contextPath}/user/payment/ERIP/mobile" method="post">
        <table style="width:32%; margin-left:50px; margin-bottom: 50px;">
            <tr>
            ...
            <tr>
                ...
                <td><input type="text" id="number" name="telephone" class="form"><br></td>
            </tr>
            <tr>
