...
<div class="content" style="border: 2px solid rgba(0,0,0,.3); border-radius: 4px;">
    <table style="width:29%; margin-left:50px; margin-bottom: 15px; margin-top:50px;">
        <tr>
            <td class="label" style="font-size: 18px;"><p style="text-align: justify;">Введите номер, состоящий из 11
                цифр, указанный в правом верхнем углу копии постановления.</p></td>
        </tr>
    </table>
    <form action="${pageContext.request.contextPath}/user/payment/ERIP/mia" method="post">
        <table style="width:38%; margin-left:50px; margin-bottom: 50px;">
            <tr>
            ...
            <tr>
                <td class="label">Номер правонарушения:</td>
                <td><input type="text" id="number" name="violateNumber" class="form"><br></td>
            </tr>
            <tr>
