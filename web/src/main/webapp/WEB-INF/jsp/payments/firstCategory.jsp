...
<div class="content" style="border: 2px solid rgba(0,0,0,.3); border-radius: 4px;">
    <table style="width:29%; margin-left:50px; margin-bottom: 15px; margin-top:50px;">
        <tr>
            <td class="label" style="font-size: 18px;"><p style="text-align: justify;">Введите номер заказа, полученный вами на сайте.</p></td>
        </tr>
    </table>
    <form action="${pageContext.request.contextPath}/user/payment/ERIP/ticket" method="post">
