...
<form>
    <table style="width:33%; margin-left:30px;">
        <tr>
            ...
            <td>
                <input type="text" id="currentLogin" class="form" style="text-align: right;">
            </td>
        </tr>
        <tr>
            <td class="label">Новый логин:</td>
            <td>
                <input type="text" id="newLogin" class="form" style="text-align: right;">
            </td>
        </tr>
        <tr>
            <td class="label">Подтверждение логина:</td>
            <td><input type="text" id="proofLogin" class="form" style="text-align: right;"><br></td>
        </tr>
        <tr>
