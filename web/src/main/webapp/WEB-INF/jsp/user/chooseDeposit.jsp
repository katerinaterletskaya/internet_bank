    ...
    <table style="margin-left:30px;">
        <tr>
            ...
            <td>
                <div class="radio-group" style="vertical-align: bottom;">
                    <input type="radio" id="option-one" name="currency" value="BYN">
                    <label for="option-one" onclick="$('#chooseCurrency').val('BYN')">BYN</label>
                    <input type="radio" id="option-two" name="currency" value="USD">
                    <label for="option-two" onclick="$('#chooseCurrency').val('USD')">USD</label>
                    <input type="radio" id="option-three" value="EUR" name="currency">
                    <label onclick="$('#chooseCurrency').val('EUR')" for="option-three">EUR</label>
                    <input type="radio" value="RUB" id="option-fourth" name="currency">
        ...
        <tr>
            ...
            <td style="padding-left: 10px;">
                <input type="text" id="summa" name="minSum" class="form" style="text-align: right;">
        ...
        <tr>
            ...
            <td style="padding-left: 10px;">
                <select id="selectDuring" name="period" class="form" style="width:100px;">
