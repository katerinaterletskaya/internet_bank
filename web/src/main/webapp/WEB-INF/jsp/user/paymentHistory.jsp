...
<table style="width:70%; margin-left:30px; color:#777777; border-collapse: collapse; border: 1px solid #d8dcdf;">
    ...
    <tr>
        <th style="text-align: center; font-size: 14px; font-family: Arial, sans-serif; letter-spacing: 2px; word-spacing: 3px; padding: 8px;">Дата платежа</th>
        <th style="text-align: center; font-size: 14px; font-family: Arial, sans-serif; letter-spacing: 2px; word-spacing: 3px; padding: 8px;">Название платежа</th>
